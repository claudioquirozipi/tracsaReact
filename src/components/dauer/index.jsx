...
function Daver() {
    return(
        <>
            ...
            <LeftRight src={img1} reverse alt={"beneficios-Dauer-correas-transportadoras-alto-rendimiento-tracsa"} >
            ...
            <LeftRight src={img2} center alt={"ficha-tecnica-Dauer-correas-transportadoras-alto-rendimiento-tracsa"}>
                <IndexText color="#357C39">
                    <h2>FICHA TÉCNICA</h2>
            ...
            <LeftRight src={img3} alt={"aplicaciones-Dauer-correas-transportadoras-alto-rendimiento-tracsa"}>
                <IndexText color="#357C39">
                    <h2>APLICACIONES</h2>
                    <ul>
                        <Li>Puertos.</Li>
